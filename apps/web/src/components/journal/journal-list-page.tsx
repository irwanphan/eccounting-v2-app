    ...
    <>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={cn(
                ...
                viewMode === 'grouped' ? 'bg-primary' : 'bg-primary/90 hover:bg-primary',
              )}
            >
              Tampil
            </button>
            <button
              ...
              disabled={loading}
              className={cn(
                'rounded-md border border-border px-4 py-2 text-sm font-medium shadow-sm transition',
                viewMode === 'detail'
      ...
      {viewEntryId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="max-h-[85vh] w-full max-w-4xl overflow-auto rounded-lg bg-white shadow-xl">
